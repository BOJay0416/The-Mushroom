...
{
    public class IK_Photon : MonoBehaviourPun, IPunObservable, IPunInstantiateMagicCallback
    {
        ...
        {
            vrRig = FindObjectOfType<XROrigin>();
            // Initiation
            ...
            Debug.Log("IK Instantiate initial");
        ...
        {
            Debug.Log("IK InitiateLocal");
            // vrRig.SetActive(true);
            SkinRender.SetActive(false);

            centerEyeAnchor = vrRig.transform.Find("Camera Offset/Main Camera");
            leftHandAnchor = vrRig.transform.Find("Camera Offset/LeftHand Controller");
            rightHandAnchor = vrRig.transform.Find("Camera Offset/RightHand Controller");
